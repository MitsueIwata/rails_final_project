...
brain_freeze = Event.create(:title => "Brain Freezathon", :location => quikEMart.location, :start_time => DateTime.new(2016,5,4,3,0), :end_time => DateTime.new(2016,5,4,4,0), :description => "gallon slushies", :user_id => bart.id, :community_id => quikEMart.id, :event_category => "slushies")
